...
import type { ReverseArray, TakeArray, SkipArray, Slice, FillLeft, FillRight, GenerateArray } from '../../index';

export type Cases = [	Expect<Equal< ReverseArray<[1, 2]> ,  [2, 1]
 >>,
	Expect<Equal< ArrayLength<[1,2,3]> ,  3>>,
	Expect<Equal< ArrayLength<any[]> ,  number>>,
 ...
 >>,
	Expect<Equal< GenerateArray<any, 2> ,  [any, any]>>,
	Expect<Equal< GenerateArray<any, 0> ,  []>>,
